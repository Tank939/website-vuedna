  ...
  <Section class="home">
    ...
    <Section wrap pad center>
      ...
      <Grid  no-gutter>
        ...
        <Column :column-width="33" :below-laptop-width="100">
          <ImageTextButtonBox :image-path="hetasImage" :image-url="hetasUrl" :title="hetasTitle" button-text="Read More">
            <p>{{hetasText}}</p>
          </ImageTextButtonBox>
        </Column>

        <Column :column-width="33" :below-laptop-width="100">
          <ImageTextButtonBox :image-path="sweepImage" :title="sweepTitle">
            <p>{{sweepText}}</p>
          </ImageTextButtonBox>
        </Column>

        <Column :column-width="33" :below-laptop-width="100">
          <ImageTextButtonBox :image-path="birdImage" :title="birdTitle">
            <p>{{birdText}}</p>
          </ImageTextButtonBox>
        </Column>

        <Column :column-width="33" :below-laptop-width="100">
          <ImageTextButtonBox :image-path="cogImage" :image-url="cogUrl" :title="cogTitle">
            <p>{{cogText}}</p>
          </ImageTextButtonBox>
        </Column>

        <Column :column-width="33" :below-laptop-width="100">
          <ImageTextButtonBox :image-path="questionImage" :title="questionTitle" button-text="Read More">
            <p>{{questionText}}</p>
          </ImageTextButtonBox>
        </Column>
      </Grid>
